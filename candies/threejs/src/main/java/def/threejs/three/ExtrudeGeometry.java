...
public class ExtrudeGeometry extends Geometry {
    ...
    public static class WorldUVGenerator extends def.js.Object {
        native public Vector2[] generateTopUV(Geometry geometry, double[] vertex, double indexA, double indexB, double indexC);
        native public Vector2[] generateSideWallUV(Geometry geometry, double[] vertex, double indexA, double indexB, double indexC, double indexD);
    }
