...
public class GridHelper extends LineSegments {
     ...
     */
    native public void setColors(Color color1, Color color2);
    public GridHelper(double size, double divisions, Color color1){}
    public GridHelper(double size, double divisions){}
    /**
     * @deprecated Colors should be specified in the constructor.
     */
    native public void setColors(Color color1);
    /**
     * @deprecated Colors should be specified in the constructor.
     */
    native public void setColors();
     ...
     * @deprecated Colors should be specified in the constructor.
     */
    native public void setColors(Color color1, double color2);
    /**
     * @deprecated Colors should be specified in the constructor.
     */
    native public void setColors(double color1, double color2);
    /**
     * @deprecated Colors should be specified in the constructor.
     */
    native public void setColors(double color1, Color color2);
    public GridHelper(double size, double divisions, double color1){}
    /**
     * @deprecated Colors should be specified in the constructor.
     */
    native public void setColors(double color1);
