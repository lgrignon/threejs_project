...
public class Matrix4 extends Matrix {
    ...
    native public Matrix4 premultiply(Matrix4 m);
    /**
     ...
     */
    native public Matrix4 makePerspective(double left, double right, double bottom, double top, double near, double far);
    /**
    ...
    native public Matrix4 fromArray(double[] array, double offset);
