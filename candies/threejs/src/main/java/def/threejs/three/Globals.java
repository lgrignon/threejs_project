...
/** This class holds all the global functions and variables of the def.threejs.three package. */
public final class Globals {
    ...
    public static final BlendingDstFactor DstColorFactor=null;
    public static final BlendingDstFactor OneMinusDstColorFactor=null;
    ...
    public static final PixelType UnsignedInt248Type=null;
    ...
    public static final PixelFormat DepthFormat=null;
    public static final PixelFormat DepthStencilFormat=null;
    ...
    public static final TrianglesDrawModes TrianglesDrawMode=null;
    ...
    public static final DepthPackingStrategies BasicDepthPacking=null;
    public static final DepthPackingStrategies RGBADepthPacking=null;
 ...
 * @deprecated
 */
    public static final double LineStrip=0;
    /**
 * @deprecated
 */
    public static final double LinePieces=0;
    public static double TextureIdCount;
    public static final AudioContext AudioContext=null;
    native public static void warn();
    native public static void error();
    native public static void log();
    public static Shader CopyShader;
    public static Object AWDLoader;
    public static Object OBJLoader2;
    public static Object STLLoader;
    public static Object FlyControls;
    public static Object BloomPass;
    public static Shader DotScreenShader;
    public static Shader RGBShiftShader;
    public static Shader FXAAShader;
    public static Boolean canvas;
    public static Boolean webgl;
    public static Boolean workers;
