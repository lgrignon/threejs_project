...
public class Vector2 extends Vector {
     ...
     */
    native public double distanceToManhattan(Vector2 v);
    /**
    ...
    native public Vector2 fromBufferAttribute(BufferAttribute attribute, double index, double offset);
     ...
     * @see {@link http://en.wikipedia.org/wiki/Taxicab_geometry|Wikipedia: Taxicab Geometry}
     */
    native public double manhattanDistanceTo(Vector2 v);
    ...
    native public Vector2 fromBufferAttribute(BufferAttribute attribute, double index);
}
