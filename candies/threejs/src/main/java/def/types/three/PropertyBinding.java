...
public class PropertyBinding extends def.js.Object {
    ...
    native public static jsweet.util.union.Union<PropertyBinding,def.types.three.propertybinding.Composite> create(Object root, Object path, Object parsedPath);
    ...
    native public static jsweet.util.union.Union<PropertyBinding,def.types.three.propertybinding.Composite> create(Object root, Object path);
