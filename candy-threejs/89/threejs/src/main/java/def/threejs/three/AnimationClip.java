...
public class AnimationClip extends def.js.Object {
    ...
    native public static AnimationClip CreateFromMorphTargetSequence(String name, MorphTarget[] morphTargetSequence, double fps, Boolean noLoop);
    native public static AnimationClip findByName(AnimationClip[] clipArray, String name);
    native public static AnimationClip[] CreateClipsFromMorphTargetSequences(MorphTarget[] morphTargets, double fps, Boolean noLoop);
