...
public class Vector4 extends Vector {
     ...
     */
    native public Vector4 copy(Vector4 v);
    /**
    ...
    native public Vector4 fromBufferAttribute(BufferAttribute attribute, double index, double offset);
    ...
    native public Vector4 fromBufferAttribute(BufferAttribute attribute, double index);
}
