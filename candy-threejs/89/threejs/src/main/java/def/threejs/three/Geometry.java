...
public class Geometry extends EventDispatcher {
     ...
     */
    native public void computeFlatVertexNormals();
    /**
    ...
    native public Geometry setFromPoints(ArrayVector2 points);
    ...
    native public void merge(Geometry geometry);
    native public Geometry setFromPoints(ArrayVector3 points);
    native public Geometry setFromPoints(Vector2[] points);
    native public Geometry setFromPoints(Vector3[] points);
    /** This class was automatically generated for disambiguating erased method signatures. */
    @jsweet.lang.Erased
    public static class ArrayVector2 extends def.js.Object {
        public ArrayVector2(Array<Vector2> points){}
    }
    /** This class was automatically generated for disambiguating erased method signatures. */
    @jsweet.lang.Erased
    public static class ArrayVector3 extends def.js.Object {
        public ArrayVector3(Array<Vector3> points){}
    }
}
