...
public class Math extends def.js.Object {
    private Math(){}
    public static final double DEG2RAD=0;
    public static final double RAD2DEG=0;
    ...
    native public static double floorPowerOfTwo(double value);
    native public static double ceilPowerOfTwo(double value);
}
